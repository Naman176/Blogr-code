...
cloudinary.config({
  cloud_name: "du2ghf4ef",
  api_key: "815212494224544",
  api_secret: "iN_r0GnIuxyF_CjYEGuwqLxBqS8",
  secure: true,
});
...
app.post("/contact", function (req, res) {
  ...
  var transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "namansuhane174@gmail.com",
      pass: "Naman123@",
    },
  });

  var mailOptions = {
    from: `namansuhane174@gmail.com`,
    to: "namansuhane174@gmail.com",
